...
BEGIN
    FOR EMP IN (SELECT EMPLOYEE_ID, EMPLOYEE_NAME, SALARY FROM EMPLOYEES WHERE SALARY > 1500) LOOP
        DBMS_OUTPUT.PUT_LINE(EMP.EMPLOYEE_ID || EMP.EMPLOYEE_NAME || EMP.SALARY);
    END LOOP;
END;
/
SELECT * FROM DEPARTMENTS;
