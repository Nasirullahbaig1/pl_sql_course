...
DECLARE
    ...
    V_EMP_ID_TWO employee.emp_id%type;
BEGIN
    SELECT EMP_NAME, EMP_ID INTO V_EMP_NAME, V_EMP_ID_TWO  FROM EMPLOYEE WHERE EMP_ID = V_EMP_ID;
    CASE
        ...
        WHEN MOD(V_EMP_ID_TWO,2) = 1 THEN
        UPDATE EMPLOYEE SET SALARY = SALARY + 5000 WHERE EMP_ID = V_EMP_ID_TWO;
        DBMS_OUTPUT.PUT_LINE('INCREMENTED THE SALARY BY 5000' );
        
        ELSE
        UPDATE EMPLOYEE SET SALARY = 1500 WHERE EMP_ID = V_EMP_ID_TWO;
