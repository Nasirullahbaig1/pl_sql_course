...
--CONTINUE STATEMENT
--CONTINUE IS USED TO BREAK THE CURRENT ITTRATION AND  GIVE CONTROL TO THE LOOP AGAIN
--ITS SOMEHOW SAME AS EXIST COMMAND BUT THE DIFFERENCE IS ONE BREAK THE WHOLE LOOP AND ONE BREAK ONLY THE CURRENT ITRATION.
